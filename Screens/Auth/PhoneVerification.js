    ...
    render() {
        return (
            <View style={{flex:1,backgroundColor:'white'}}>
                ...
                <Text style={{fontSize:32,lineHeight:38,margin:20,color:Colors.HEADING,fontStyle:'normal',fontWeight:'900',fontFamily:'Avenir-Heavy',letterSpacing:0.4}}>Email Verification</Text>
                <Text style={{fontSize:18,width:300,marginLeft:20,marginTop:10,marginBottom:30,color:Colors.HEADING,fontFamily:'Avenir-Heavy',fontStyle:'normal'}}>Please enter your email for verification</Text>
